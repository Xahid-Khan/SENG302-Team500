...
public class MessageControllerTest {
    ...
    void getAllConversationsTestValidNoOffset() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/messages"))
                ...
                .andReturn();
        Mockito.verify(messageService).getPaginatedConversations(3, 0, 20);
    }
    ...
    void getAllConversationsTestValidOffset() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/messages").param("offset", "1"))
                .andExpect(status().isOk())
                .andReturn();
        Mockito.verify(messageService).getPaginatedConversations(3, 1, 20);
    }
    ...
    void sendMessageTestValid() throws Exception {
        Mockito.when(messageService.isInConversation(3, 1)).thenReturn(true);
        Mockito.when(messageService.sendMessage(anyInt(), anyInt(), any())).thenReturn(true);
        var body = """
                {
                    "messageContent": "hey",
                    "sentBy": 3
        ...
        mockMvc.perform(post("/api/v1/messages/1")
                ...
                .andExpect(status().isOk())
                .andReturn();
        Mockito.verify(messageService).sendMessage(anyInt(), anyInt(), any());
    }
    ...
    void deleteMessageTestValid() throws Exception {
        Mockito.when(messageService.isInConversation(3, 1)).thenReturn(true);
        Mockito.when(messageService.deleteMessage(1, 1)).thenReturn(true);
        mockMvc.perform(delete("/api/v1/messages/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("1"))
                .andExpect(status().isOk())
                .andReturn();
        Mockito.verify(messageService).deleteMessage(1, 1);
    }
    ...
    void updateConversationTestValid() throws Exception {
        Mockito.when(messageService.isInConversation(3, 1)).thenReturn(true);
        Mockito.when(conversationService.updateConversation(any(), any())).thenReturn(true);
    ...
    void createConversationTestValid() throws Exception {
        Mockito.when(messageService.isInConversation(3, 1)).thenReturn(true);
        Mockito.when(conversationService.createConversation(any())).thenReturn(true);
