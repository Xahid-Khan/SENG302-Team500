    ...
    constructAndPopulateView() {
        this.containerElement.innerHTML = `
              <div class="project-title">
                  ...
                  <span class="crud">
                      <button class="button icon-button project-delete-button" onclick="document.getElementById('modal-open').style.display='block'" id="project-delete-button-${this.project.id}" data-privilege="course_admin"><span class="material-icons">clear</span></button>
