...
public class DeadlineMapper {
    ...
    /**
     * This method receives an deadline Entity and converts that entity into transferable JSON data type,
     * while doing so it also retrieves all and deadlines related to that deadline.
