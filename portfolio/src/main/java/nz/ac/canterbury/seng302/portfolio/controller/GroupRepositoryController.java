...
public class GroupRepositoryController extends AuthenticatedController {
  @Autowired GroupRepositoryService groupRepositoryService;
  ...
  public ResponseEntity<Boolean> update(
    ...
    try {
      var result =
          groupRepositoryService.update(
              groupRepositoryContract.groupId(),
              groupRepositoryContract.repositoryId(),
              groupRepositoryContract.token());
